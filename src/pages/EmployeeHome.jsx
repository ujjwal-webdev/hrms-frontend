        ...
        switch (selectedFeature) {
            ...
            case 'updateAddress':
                return (
                    <div className="mt-4">
                        ...
                        <form onSubmit={handleUpdateAddress} className="mt-3">
                            <div className="form-group">
            ...
            case 'listAllAddresses':
                return (
                    <div className="mt-4">
                        <h3>All Addresses</h3>
                        <button className="btn btn-primary mb-3" onClick={fetchAllAddresses}>
                            Load Addresses
                        </button>
                        {addresses.length > 0 ? (
            ...
            case 'updateLeave':
                return (
                    <div className="mt-4">
                        <h3>Update Leave</h3>
                        <form onSubmit={submitUpdatedLeave}>
                            <div className="form-group">
                                <label htmlFor="reason">Reason:</label>
                                <textarea
                                    id="reason"
            ...
            case 'deletePendingLeave':
                return (
                    <div className="mt-4">
                        ...
                        <button className="btn btn-danger" onClick={deletePendingLeaveHandler}>
            ...
            case 'checkLeaveStatus':
                return (
                    <div className="mt-4">
                        ...
                        <button className="btn btn-primary" onClick={checkLeaveStatusHandler}>
            ...
            case 'getAllLeaves':
                return (
                    <div className="mt-4">
                        ...
                        <button className="btn btn-primary" onClick={getAllLeavesHandler}>
                            Get All Leaves
                        </button>
                        {leaveList.length > 0 ? (
                            <div className="mt-3">
            ...
            case 'checkWork':
                return (
                    <div className="mt-4">
                        ...
                        <button className="btn btn-primary" onClick={getAllWorksHandler}>
                            Get All Works
                        </button>
                        {workList.length > 0 ? (
                            <div className="mt-3">
                ...
                return (
                    <div className="mt-4">
                        ...
                        <button
                            ...
                            onClick={changeWorkStatusHandler} // Call the handler when the button is clicked
                        >
            ...
            case 'addWorkExperience':
                return (
                    <div className="mt-4">
                        ...
                        <form onSubmit={addWorkExperienceHandler}>
                            <div className="form-group">
